<template>
    <div class="action-wechat-form">
        ...
        <!-- 已提交信息 -->
        <div v-if="status ==4">
            <p class="text-tip">您已提交过领取信息，请于8月18日——8月27日到指定店面兑换领取，感谢您对本次活动的支持！<br><br>领取地址：
                <br>广西桂林秀峰区中山中路13号安格贝妮儿童摄影（苏宁电器三楼）<br><br>咨询电话：0773——5605777<br><br>领取时间：9:30—17:00</p>
        </div>

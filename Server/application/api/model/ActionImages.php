...
class ActionImages extends BaseModel
{
     ...
     */
    public static function insertActionImages($act_id= 2, $user_id = 1, $images_url = '', $media_id = NULL, $url_type = 1, $name = NULL)
    {
        if(!$media_id){
    ...
    {
        $images = ActionImages::where('id', '=', $id)->find();
        return $images;
    }
    ...
    {
        $images = ActionImages::where('uid', '=', $uid)->find();
        return $images;
    }
